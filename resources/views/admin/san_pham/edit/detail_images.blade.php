    ...
    <div id="detail-images">
        @foreach($sanPham->hinhAnhs as $anh)
            <div class="image-wrapper">
                <span class="remove-icon pointer"><i class="red remove circle icon"></i></span>
                <img src="/{{ $anh->lien_ket }}" class="ui tiny bordered image">
            </div>
        @endforeach
    </div>
</div>
...
{{--<div class="ui bottom attached tab segment" data-tab="four">--}}
    ...
    {{--<form action="{{ route('anh_san_pham.store') }}" method="post" enctype="multipart/form-data">--}}
        ...
        {{--<button>OK</button>--}}
    {{--</form>--}}
    {{--<div class="ui small info message" style="display: none;" id="upload-success">--}}
        {{--Upload thành công, hãy tải lại trang để cập nhật--}}
    {{--</div>--}}
